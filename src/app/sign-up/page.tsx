    ...
    <div className="relative h-screen w-screen p-16 flex items-center justify-center bg-coolbeige">
      <div className="max-w-[1440px] w-full flex flex-col items-center">
        <div className="h-fit w-2xl px-12 py-10 bg-snowwhite rounded-3xl">
          ...
          <p className="pb-4 text-md font-semibold text-center">Already have an account? Click <Link href={'/sign-in/'} className="text-darkpink hover:text-mauve transition-colors">here</Link> to sign in.</p>
