    ...
    <div className="modal" data-cy="search-results">
      <div className="modal-inner">
        <div className="p-2 flex items-center justify-between lg:p-4">
          <h4 className="modal-heading">Search Results</h4>
        ...
        <div className="px-2 py-4 flex flex-col lg:px-4">
          { // Display a loading message while waiting for results
            !results && <p className="description">Loading results...</p>
          }
          { // Display an error message if no results were found
            // or if the user has exceeded their rate limit
            results?.kind === 'error' && (
              <p className="description" data-cy="error-message">{results.message}</p>
            )
          }
                ...
                <div key={place._id} className="relative mb-8 space-y-2 bg-snowwhite cursor-pointer"
                  ...
                  <div className="flex flex-col font-semibold">
                    ...
                    {showConfirmation && place._id === placeId &&
                      <p className="notification text-darkpink" data-cy="search-result-confirmation">(Place has been added to your list!)</p>
                    }
                  </div>
                  <div className="flex gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 .75.75V21m-4.5 0h4.36m11.14 0H18m0 0h3.64m-1.39 0V9.349M3.75 21V9.349m0 0a3.001 3.001 0 0 0 3.75-.615A2.993 2.993 0 0 0 9.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 0 0 2.25 1.016c.896 0 1.7-.393 2.25-1.015a3.001 3.001 0 0 0 3.75.614m-16.5 0a3.004 3.004 0 0 1-.621-4.72l1.189-1.19A1.5 1.5 0 0 1 5.378 3h13.243a1.5 1.5 0 0 1 1.06.44l1.19 1.189a3 3 0 0 1-.621 4.72M6.75 18h3.75a.75.75 0 0 0 .75-.75V13.5a.75.75 0 0 0-.75-.75H6.75a.75.75 0 0 0-.75.75v3.75c0 .414.336.75.75.75Z" />
                    </svg>
                    <p className="description-sm">{place.type}</p>
                  </div>
                  <div className="flex gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    ...
                    <p className="description-sm">{place.address}</p>
                  </div>
                  <Link href={place.mapsUrl} target="_blank" className="block w-fit">
                    <div className="group flex gap-2">
                      ...
                      <p className="description-sm group-hover:text-mauve transition-colors">Google Maps</p>
                    </div>
                  </Link>
                </div>
              );
