        ...
        <div className="max-h-full flex gap-8 overflow-y-auto">
          <div className="w-1/2 flex flex-col gap-2">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold">{`${list.restaurants.length} Places`}</h2>
                    ...
                    <div className="flex relative p-8 border border-lightgray rounded-3xl cursor-pointer">
                      ...
                      {/* Modal for menu */
                        selectedMenuModal === restaurant._id && (
                          <div className="flex flex-col absolute right-9 top-16 min-w-30 p-2 bg-snowwhite border border-lightgray rounded-sm">
                            <button
            ...
            <div className="fixed flex items-center justify-center inset-0 w-full h-full bg-(--modal-background)">
              <div className="relative px-6 py-8 w-2/5 bg-snowwhite rounded-lg">
                <div className="p-4 flex items-center justify-between">
                  <h2 className="text-3xl font-semibold text-darkpink">Edit {selectedRestaurant.name}</h2>
                ...
                <div className="p-4 flex flex-col">
                  ...
                  <button className="px-4 py-2 self-start text-snowwhite font-bold bg-darkpink rounded-lg cursor-pointer hover:bg-mauve transition-colors" onClick={() => handleEditClick(selectedRestaurant._id)}>Update</button>
                </div>
              </div>
            </div>
          )
          ...
          showDeleteAlert && selectedRestaurant && (
            <div className="fixed flex items-center justify-center inset-0 w-full h-full bg-(--modal-background)">
              <div role="alert" className="relative px-6 py-8 w-1/5 border rounded-lg bg-snowwhite">
                <h3 className="mb-4 text-2xl font-semibold text-darkpink">Are you sure you want to remove this restaurant?</h3>
                <div className="flex">
                  <button type="button"
