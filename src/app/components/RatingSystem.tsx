      ...
      {[...Array(5)].map((_, i) => {
        ...
        return (
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="size-6 cursor-pointer"
            ...
            {/* Left half */}
            <path
              className={`pointer-events-auto transition-all duration-200 ${leftHalf ? "fill-blue-900" : "fill-transparent"}`}
              d="M12 2.25L8.91 9.68l-7.16.57 5.42 4.65L5.03 22 12 18.27V2.25Z"
            />
            {/* Right half */}
            <path
              className={`pointer-events-auto transition-all duration-200 ${rightHalf ? "fill-blue-900" : "fill-transparent"}`}
              d="M12 2.25v16.02L18.97 22l-2.14-7.1 5.42-4.65-7.16-.57L12 2.25Z"
            />
            {/* Outline */}
            <path className="pointer-events-none" fill="none" stroke="var(--color-blue-900)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"
