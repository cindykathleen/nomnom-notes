  ...
  return (
    <div className="relative h-screen p-16 sm:ml-64">
      <div className="w-1/3 m-auto px-16 py-8 border border-gray-200 rounded-3xl">
        <h2 className="pb-2 text-3xl font-semibold text-blue-900 text-center">Sign in</h2>
        <p className="pb-4 text-md font-semibold text-center">Don't have an account? Click <Link href={'/sign-up/'} className="text-blue-900 hover:underline">here</Link> to create one.</p>
